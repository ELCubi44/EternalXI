-- Traducciones de catálogo (es / en). Los textos base en temporadas/equipos/jugadores
-- siguen como fallback en español hasta migrar datos nuevos.
...
-- Copiar textos actuales como español (idempotente)
