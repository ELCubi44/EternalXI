-- Kick/leave: conservar auditoría en liga_recompensa_eventos al borrar liga_participantes.
-- id_liga_participante ya es NULLable; las FK pasan a ON DELETE SET NULL.
...
ALTER TABLE liga_recompensa_eventos
    DROP FOREIGN KEY fk_lre_participante;
...
ALTER TABLE liga_recompensa_eventos
    DROP FOREIGN KEY fk_lre_part_obj;
