-- ============================================================================
-- MANUAL: Ajuste definiciones de carta - 2026-05-15
-- Ejecutar con: mysql EternalXI < manual_ajuste_cartas_20260515.sql
-- O copiar y pegar bloques individuales con mysql EternalXI -e "..."
...
-- DIRECT_CLAUSE: todo a x1.0, legendaria max 150M
...
-- Verificación
SELECT codigo, nombre, rareza, parametros_json, descripcion
FROM definiciones_carta
ORDER BY tipo_efecto, FIELD(rareza, 'BASIC','NORMAL','SPECIAL','SUPER_RARE','LEGENDARY');
