-- Manual (MySQL sin IF NOT EXISTS en ALTER): progreso de cuenta y logros
-- Ejecutar una vez en producción si /users/{id}/progress falla por columnas/tablas ausentes.
